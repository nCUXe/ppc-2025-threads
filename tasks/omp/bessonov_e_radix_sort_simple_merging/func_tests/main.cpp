...
TEST(bessonov_e_radix_sort_simple_merging_omp, FirstTest) {
...
TEST(bessonov_e_radix_sort_simple_merging_omp, SingleElementTest) {
...
TEST(bessonov_e_radix_sort_simple_merging_omp, NegativeAndPositiveTest) {
...
TEST(bessonov_e_radix_sort_simple_merging_omp, RandomVectorTest) {
...
TEST(bessonov_e_radix_sort_simple_merging_omp, AllSameElementsTest) {
...
TEST(bessonov_e_radix_sort_simple_merging_omp, ExtremeValuesTest) {
...
TEST(bessonov_e_radix_sort_simple_merging_omp, TinyNumbersTest) {
